...
int le[500],re[500];
void edgedetect(float x1,float yy1,float x2,float y2);
void scanflie(float x1,float yy1,float x2,float y2,float x3,float y3,float x4,float y4);
void display();
void myInit();
void fill_menu();
void edgedetect(float x1,float yy1,float x2,float y2)
...
edgedetect(x1,yy1,x2,y2);
edgedetect(x2,y2,x3,y3);
edgedetect(x4,y4,x3,y3);
edgedetect(x1,yy1,x4,y4);
for( y=200; y<=400;y++)
{
for(i=le[y];i<=re[y];i++)
{
...
void display()
{
	x1=200.0;yy1=200.0;x2=100.0;y2=300.0;x3=200.0;y3=400.0; x4=300.0;y4=300.0;
	glFlush();
}
void myInit()
{
